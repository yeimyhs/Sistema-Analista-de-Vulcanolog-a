...
CREATE TABLE public."Blob" (
    ...
    "stateBlob" smallint,
    "dateCreationBlob" timestamp with time zone NOT NULL,
...
CREATE TABLE public."Explosion" (
    ...
    "idImage" character varying(21) NOT NULL,
    "idMask" character varying(21) NOT NULL,
    height double precision NOT NULL,
    "ashDirection" character varying(30) NOT NULL,
    "idWinddir" character varying(19),
    "idAshDispersion" character varying(17),
    "idAshfallprediction" character varying(20),
    "detectionMode" character varying(2),
    "idVolcano" character varying(3) NOT NULL,
    ind character varying(2),
    "idStation" character varying(4)
);
...
CREATE TABLE public."ImageSegmentation" (
    ...
    "stateImg" smallint,
    "dateCreationImg" timestamp with time zone NOT NULL,
    "idStation" character varying(5) NOT NULL
)
WITH (autovacuum_enabled='true');
...
CREATE TABLE public."WindDirection" (
    "startTimeWinddir" timestamp with time zone NOT NULL,
...
CREATE INDEX "IX_Relationship10" ON public."AlertConfiguration" USING btree ("idVolcano");
...
--
-- Name: AlertConfiguration AlertConfiguration_idVolcano_049feca2_fk; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public."AlertConfiguration"
    ADD CONSTRAINT "AlertConfiguration_idVolcano_049feca2_fk" FOREIGN KEY ("idVolcano") REFERENCES public."Volcano"("idVolcano") DEFERRABLE INITIALLY DEFERRED;
